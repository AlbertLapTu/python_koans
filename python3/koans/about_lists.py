...
class AboutLists(Koan):
    ...
    def test_list_literals(self):
        ...
        # Splicing to create new list instance. Will fail otherwise
        nums[0:] = [1]
    ...
    def test_slicing_to_the_edge(self):
        noms = ['peanut', 'butter', 'and', 'jelly']
        # Assume "to the end/beginning" if no to/from index provided
    ...
    def test_ranges_with_steps(self):
        ...
        self.assertEqual([5,1,-3], list(range(5, -7, -4))) # Exclusive
