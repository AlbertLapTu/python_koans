...
class AboutListAssignments(Koan):
    ...
    # Parallel assignments assign variables to destructured arrays
    ...
    # Python parallel assignment can destructure a value from a data structure
