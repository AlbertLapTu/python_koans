...
class AboutSets(Koan):
    ...
    def test_dictionaries_and_sets_use_same_curly_braces(self):
        ...
        self.assertEqual({'one': 1}.__class__, {'one': 1, 'two': 2}.__class__)
    ...
    # Sets can be compared by their unicode values
