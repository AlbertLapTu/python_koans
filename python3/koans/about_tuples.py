...
"""
Tuples are an immutable sequence of ordered python objects.
Use tuples to group together related data. 

Ex: Directions (North, East, South, West)
"""
...
class AboutTuples(Koan):
    ...
    def test_tuples_can_only_be_changed_through_replacement(self):
        ...
        # Reconvert back to tuple in order to work around immutability
